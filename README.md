1. Collected data for different activities are in sitting_data.csv, standing_data.csv, walking_data.csv, running_data.csv, stairs_data.csv, cycling_data.csv for the respective activities.
